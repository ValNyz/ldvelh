...
Tu analyses un narratif de jeu de rôle SF pour en générer un résumé et en extraire les opérations sur le Knowledge Graph.
...
{
  "resume": "Résumé de la scène en 2-6 phrases (qui, quoi, où, comment, pourquoi, conséquences)",
  "operations": [
    { "op": "...", ... }
  ],
  "contradictions": [],
