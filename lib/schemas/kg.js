...
const VALEURS_CANONIQUES = {
	...
	etat_objet: {
		...
		'damaged': 'abime', 'broken': 'casse', 'cassé': 'casse',
	},
...
const OperationSchema = z.discriminatedUnion('op', [
	...
	CreerRelationSchema,
	ModifierRelationSchema,
	TerminerRelationSchema,
	ModifierEtatSchema,
	CreerEvenementSchema,
	PlanifierEvenementSchema,
	RealiserEvenementSchema,
	AnnulerEvenementSchema,
]);
...
export function validerOperation(operation) {
	...
	const opNormalisee = {
		...operation,
		op: normaliserNomOperation(operation.op),
	};

	const result = OperationSchema.safeParse(opNormalisee);
