 ...
 */
import { CACHE_TTL, CACHE_LIMITS } from '../constants.js';
...
const CONFIG = {
	TTL: {
		protagoniste: CACHE_TTL.PROTAGONISTE,
		ia: CACHE_TTL.IA,
		stats: CACHE_TTL.STATS,
		relations: CACHE_TTL.RELATIONS,
		personnages: CACHE_TTL.PERSONNAGES,
		lieux: CACHE_TTL.LIEUX,
		inventaire: CACHE_TTL.INVENTAIRE,
		scene: CACHE_TTL.SCENE,
		evenements: CACHE_TTL.EVENEMENTS,
		connaissances: CACHE_TTL.CONNAISSANCES,
		default: CACHE_TTL.DEFAULT
	},
	MAX_ENTRIES_PER_PARTIE: CACHE_LIMITS.MAX_ENTRIES_PER_PARTIE,
	MAX_PARTIES: CACHE_LIMITS.MAX_PARTIES
};
