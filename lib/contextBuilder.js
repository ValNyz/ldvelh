...
function buildContext({
	...
	context += formatSceneActuelle(lieuActuel, pnjsPresentsLastScene, allPnj);
...
async function buildContextForClaude(
	...
	const [pnjResult, messagesResult, resumesResult, lieuActuelResult, pnjsPresentsResult, transactionsResult] = await Promise.all([
		preloadedPnj
