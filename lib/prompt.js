...
## EXTRACTION DES FAITS (TOUS LES MODES)

À chaque réponse, identifie les faits nouveaux ou modifiés.
Maximum 5 faits nouveaux et 3 modifications par réponse.
...
- NE PAS extraire : ambiance, émotions passagères
- Importance 5 = impact majeur sur les interactions futures
- valentin_sait: false pour les événements hors-champ que Valentin ignore
`;
