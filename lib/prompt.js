...
## RENDEZ-VOUS ET ENGAGEMENTS (CRITIQUE)
...
### Transactions (RÈGLES STRICTES)

**AVANT tout achat :**
1. Vérifie le solde de Valentin dans === VALENTIN === (ligne "Crédits:")
2. Si montant_achat > crédits_disponibles → REFUSER la transaction
3. Narrativement : le commerçant refuse, le terminal affiche "Solde insuffisant", etc.

**Exemples :**
- Crédits: 50 → Peut acheter café (5 cr) ✓
- Crédits: 50 → Ne peut PAS acheter repas (75 cr) ✗
- Crédits: 0 → Ne peut RIEN acheter
...

{
  ...
  "transactions": [
    {"type": "achat", "montant": -45, "objet": "Plante verte", "quantite": 1, "categorie": "decoration", "etat": "neuf", "valeur_neuve": 50, "localisation": "Appartement 1247", "description": "Achetée au marché"}
  ],
...
**Types :** achat, vente, salaire, loyer, facture, amende, pourboire, service, remboursement, don, cadeau_recu, pret, emprunt, retour_pret, perte, oubli, vol, destruction, degradation, reparation, deplacement

**Catégories objets :** nourriture, outils, equipement, vetements, decoration, electronique, documents, mobilier, hygiene, loisirs, consommable

**États :** neuf, bon, use, endommage, casse

**Localisations :** "sur_soi", "Sac à dos", "Appartement XXXX" (nom exact), "Bureau", nom de lieu, ou nom PNJ (pour don)

**Exemples :**
- Achat objet : {"type": "achat", "montant": -45, "objet": "Plante verte", "categorie": "decoration", "etat": "neuf", "valeur_neuve": 50, "localisation": "Appartement 1247", "description": "..."}
- Achat conso : {"type": "achat", "montant": -8, "description": "Café"}
- Don : {"type": "don", "objet": "Couteau", "localisation_depuis": "sur_soi", "localisation_vers": "Justine Lépicier", "pnj_name": "Justine Lépicier", "description": "..."}
- Cadeau reçu : {"type": "cadeau_recu", "objet": "Badge", "categorie": "decoration", "valeur_neuve": 20, "etat": "bon", "pnj_name": "Marco Delgado", "localisation": "sur_soi"}
- Déplacement : {"type": "deplacement", "objet": "Tablet", "localisation_depuis": "Appartement 1247", "localisation_vers": "Sac à dos"}
- Dégradation : {"type": "degradation", "objet": "Tablet", "ancien_etat": "bon", "nouvel_etat": "endommage"}
- Oubli/perte : {"type": "oubli", "objet": "Parapluie", "localisation_depuis": "Bar Eclipse"}
- Prêt : {"type": "pret", "objet": "Livre", "pnj_name": "Justine Lépicier"}
- Financier : {"type": "salaire", "montant": 2000} / {"type": "loyer", "montant": -600}
...
### Cohérence inventaire

- Consulte la section "Inventaire" dans === VALENTIN === avant toute transaction
- Un objet donné/vendu/perdu DOIT exister dans l'inventaire
- Utilise le nom EXACT de l'objet tel qu'il apparaît
- Les déplacements changent la localisation, pas la possession
- Un objet prêté reste dans l'inventaire (marqué "prêté à X")
...
- Si RDV raté → prévoir les conséquences relationnelles
...
- Noms EXACTS depuis le contexte (lieux, PNJ, objets)
...
- Transactions : vérifier l'inventaire avant don/vente/déplacement
`;
