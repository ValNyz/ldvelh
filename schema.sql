...
GRANT ALL ON games TO neondb_owner;
GRANT ALL ON entities TO neondb_owner;
GRANT ALL ON entity_protagonists TO neondb_owner;
GRANT ALL ON entity_characters TO neondb_owner;
GRANT ALL ON entity_locations TO neondb_owner;
GRANT ALL ON entity_objects TO neondb_owner;
GRANT ALL ON entity_ais TO neondb_owner;
GRANT ALL ON entity_organizations TO neondb_owner;
GRANT ALL ON skills TO neondb_owner;
GRANT ALL ON attributes TO neondb_owner;
GRANT ALL ON relations TO neondb_owner;
GRANT ALL ON relations_social TO neondb_owner;
GRANT ALL ON relations_professional TO neondb_owner;
GRANT ALL ON relations_spatial TO neondb_owner;
GRANT ALL ON relations_ownership TO neondb_owner;
GRANT ALL ON facts TO neondb_owner;
GRANT ALL ON fact_participants TO neondb_owner;
GRANT ALL ON beliefs TO neondb_owner;
GRANT ALL ON contradictions TO neondb_owner;
GRANT ALL ON events TO neondb_owner;
GRANT ALL ON event_participants TO neondb_owner;
GRANT ALL ON commitments TO neondb_owner;
GRANT ALL ON commitment_arcs TO neondb_owner;
GRANT ALL ON commitment_entities TO neondb_owner;
GRANT ALL ON chat_messages TO neondb_owner;
GRANT ALL ON cycle_summaries TO neondb_owner;
GRANT ALL ON extraction_logs TO neondb_owner;

GRANT SELECT ON v_active_entities TO neondb_owner;
GRANT SELECT ON v_active_relations TO neondb_owner;
GRANT SELECT ON v_current_attributes TO neondb_owner;
GRANT SELECT ON v_current_skills TO neondb_owner;
GRANT SELECT ON v_beliefs TO neondb_owner;
GRANT SELECT ON v_upcoming_events TO neondb_owner;
GRANT SELECT ON v_inventory TO neondb_owner;
GRANT SELECT ON v_characters_context TO neondb_owner;
GRANT SELECT ON v_active_commitments TO neondb_owner;
GRANT SELECT ON v_recent_facts TO neondb_owner;
GRANT SELECT ON v_open_contradictions TO neondb_owner;

GRANT EXECUTE ON FUNCTION find_entity(UUID, TEXT, entity_type) TO neondb_owner;
GRANT EXECUTE ON FUNCTION upsert_entity(UUID, entity_type, VARCHAR, TEXT[], INTEGER, BOOLEAN) TO neondb_owner;
GRANT EXECUTE ON FUNCTION set_attribute(UUID, UUID, VARCHAR, TEXT, INTEGER, JSONB) TO neondb_owner;
GRANT EXECUTE ON FUNCTION upsert_relation(UUID, UUID, UUID, relation_type, INTEGER, certainty_level, BOOLEAN, VARCHAR) TO neondb_owner;
GRANT EXECUTE ON FUNCTION end_relation(UUID, TEXT, TEXT, relation_type, INTEGER, TEXT) TO neondb_owner;
GRANT EXECUTE ON FUNCTION create_fact(UUID, INTEGER, fact_type, TEXT, fact_domain, UUID, VARCHAR, INTEGER, JSONB) TO neondb_owner;
GRANT EXECUTE ON FUNCTION set_belief(UUID, UUID, VARCHAR, TEXT, INTEGER, BOOLEAN, certainty_level, UUID) TO neondb_owner;
GRANT EXECUTE ON FUNCTION set_skill(UUID, UUID, VARCHAR, INTEGER, INTEGER) TO neondb_owner;
GRANT EXECUTE ON FUNCTION credit_transaction(UUID, INTEGER, INTEGER, TEXT) TO neondb_owner;
GRANT EXECUTE ON FUNCTION update_gauge(UUID, VARCHAR, NUMERIC, INTEGER) TO neondb_owner;
GRANT EXECUTE ON FUNCTION rollback_to_cycle(UUID, INTEGER) TO neondb_owner;
